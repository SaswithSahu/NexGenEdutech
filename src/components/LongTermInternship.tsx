...
const internshipDetails = {
  ...
  eligibility: "Final-year students, Graduates, and Early Professionals",
  benefits: [
    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen py-16 px-6">
      ...
      <div className="max-w-5xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg text-center">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Why Choose Our Internship?</h3>
